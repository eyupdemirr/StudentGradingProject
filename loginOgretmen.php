...
if (isset($_POST["giris"])) {
    ...
    if (isset($name) && isset($surname) && isset($password)) {
        $secim = "SELECT * FROM ogretmenler WHERE isim = '$name'";
        ...
        if ($kayitsayisi > 0) {
            ...
            if (password_verify($password, $hashsifre)) {
                ...
                if ($rol == "ogrenci") {
                    header("location: loginOgrenci.php");
                    exit;
                } elseif ($rol == "ogretmen") {
                    ...
                    // Diğer roller için gerekli yönlendirme ve işlemler
                }
            } else {
            ...
            $ogretmenSecim = "SELECT * FROM kullanicilar WHERE isim = '$name'";
...
<html lang="tr-TR">
  ...
  <body>
    <div class="container p-5">
        <div class="card p-5">
            <form action="loginOgretmen.php" method="POST">
                <h2><b>Öğretmen Giriş Ekranı</b></h2>
                ...
                <a href="loginOgrenci.php" class="btn btn-primary float-right mr-1">Öğrenci Giriş</a>
            </form>
            <br>
