...
if (isset($_POST["kaydet"])) {
    ...
    if (isset($name) && isset($surname) && isset($password)) {
        $ekle = "INSERT INTO kullanicilar (isim, soyad, sifre, roles) VALUES ('$name','$surname','$password', 'ogrenci')";
...
<html lang="tr-TR">
  ...
  <body>
    <div class="container p-5">
        <div class="card p-5">
            <form action="kayitOgrenci.php" method="POST">
                <h2><b> Öğrenci Kayıt Ekranı </b></h2>
            ...
            <p>Öğretmen hesapları için, lütfen işvereninizle irtibata geçin..</p>
        </div>
    </div>
