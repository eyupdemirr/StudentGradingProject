...
if (isset($_POST["kaydet"])) {
    ...
    if (isset($name) && isset($surname) && isset($password)) {
        $ekle = "INSERT INTO kullanicilar (isim, soyad, sifre, roles) VALUES ('$name','$surname','$password', 'admin')";
...
<html lang="tr-TR">
  ...
  <body>
    <div class="container p-5">
        <div class="card p-5">
            <form action="kayitAdmin.php" method="POST">
                <h2><b> Admin Kayıt Ekranı </b></h2>
